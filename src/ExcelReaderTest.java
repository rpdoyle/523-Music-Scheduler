...
public class ExcelReaderTest {
	...
	public void testGetStartTimeArr() {
		...
		try {
			times = new String[] { "12:00-3:51AM", "12:00-3:51PM",
					"8:37-9:53 AM", "5:00-6:00 PM", "04:00-5:00 am",
					"10:00-11:00pm" };
			assertArrayEquals(new int[] { 0, 720, 517, 1020, 240, 1320 },
					ExcelReader.getStartTimeArr(times, 0));
		} catch (InvalidInputFormatException e) {
			fail("Threw unexpected exception");
		}
		...
		try {
			times = new String[] { "12:00-3:51AM", "12:00-3:51PM",
					"8:37-9:53 AM", "5:00-6:00 PM", "04:00-5:00 am",
					"10:00-11:00pm" };
			assertArrayEquals(new int[] { 1440, 2160, 1957, 2460, 1680, 2760 },
					ExcelReader.getStartTimeArr(times, 1));
		} catch (InvalidInputFormatException e) {
			fail("Threw unexpected exception");
		}
		...
		try {
			times = new String[] { "12:00-3:51AM", "12:00-3:51PM",
					"8:37-9:53 AM", "5:00-6:00 PM", "04:00-5:00 am",
					"10:00-11:00pm" };
			assertArrayEquals(new int[] { 2880, 3600, 3397, 3900, 3120, 4200 },
					ExcelReader.getStartTimeArr(times, 2));
		} catch (InvalidInputFormatException e) {
			fail("Threw unexpected exception");
		}
		...
		try {
			times = new String[] { "12:00-3:51AM", "12:00-3:51PM",
					"8:37-9:53 AM", "5:00-6:00 PM", "04:00-5:00 am",
					"10:00-11:00pm" };
			assertArrayEquals(new int[] { 4320, 5040, 4837, 5340, 4560, 5640 },
					ExcelReader.getStartTimeArr(times, 3));
		} catch (InvalidInputFormatException e) {
			fail("Threw unexpected exception");
		}
		...
		try {
			times = new String[] { "12:00-3:51AM", "12:00-3:51PM",
					"8:37-9:53 AM", "5:00-6:00 PM", "04:00-5:00 am",
					"10:00-11:00pm" };
			assertArrayEquals(new int[] { 5760, 6480, 6277, 6780, 6000, 7080 },
					ExcelReader.getStartTimeArr(times, 4));
		} catch (InvalidInputFormatException e) {
			fail("Threw unexpected exception");
		}
