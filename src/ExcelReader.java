...
public class ExcelReader {
	...
	public static void parseRoomData(String filepath) throws FileNotFoundException, IOException, InvalidInputFormatException {
		...
		while (rowsIterator.hasNext()) { 
			...
			String[] mondayTimesArr = getStringArrayFromCell(currentRow, 3);
			String[] tuesdayTimesArr = getStringArrayFromCell(currentRow, 4);
			String[] wednesdayTimesArr = getStringArrayFromCell(currentRow, 5);
			String[] thursdayTimesArr = getStringArrayFromCell(currentRow, 6);
			String[] fridayTimesArr = getStringArrayFromCell(currentRow, 7);
