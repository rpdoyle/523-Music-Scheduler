...
public class StudentTest {
	...
	public void testGetInstruments() {
		Student testStudent = createTestStudent();
		assertArrayEquals(new String[] { "Guitar, Flute, Violin" },
				testStudent.getInstruments());
	}

	@Test
	public void testGetInstrumentYears() {
		Student testStudent = createTestStudent();
		assertArrayEquals(new String[] { "Less than 1 year",
				"More than 4 years" }, testStudent.getInstrumentYears());
	}
	...
	public void testGetAvailableTimes() {
		Student testStudent = createTestStudent();
		assertArrayEquals(new int[] { 500, 1247, 5383 },
				testStudent.getAvailableTimes());
	}

	@Test
	public void testGetSiblings() {
		Student testStudent = createTestStudent();
		assertArrayEquals(new ArrayList<Student>().toArray(), testStudent
				.getSiblings().toArray());
		...
		assertArrayEquals(siblings.toArray(), testStudent.getSiblings()
				.toArray());
	}
