...
public class ExcelWriterTest {
	...
	public void testPrepareDataToWriteToExcel() {
		...
		// This pair has the same day and time as the last one but in a different room
		...
		// This pair has the same room and time as the last one but on a different day
